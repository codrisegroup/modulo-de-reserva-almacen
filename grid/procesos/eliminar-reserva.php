...
$link = Conectarse();
   ...
   $query  =  "SELECT CRV.NRORESERVA,CRV.OT,T.TDESCRI,
	CRV.USUARIO,T.TCLAVE,CRV.IDAREA,CONVERT(VARCHAR,CRV.FECHA,103)AS FECHA,
...
<td><a href="../pages/editar-reserva?id=<?php echo $fila->NRORESERVA;?>" target="_blank"><i class="fa fa-search fa-2x"></i></a></td>
