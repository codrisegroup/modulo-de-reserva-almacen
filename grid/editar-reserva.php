...
$query  =  "SELECT IDRESERVA_DET,NRORESERVA,CODIGO,CANTIDAD,CANT_PEND,ADESCRI,AUNIDAD,NUMERO_DOC,REQUERIMIENTO FROM [022BDCOMUN].DBO.RESERVA_DET AS D INNER  JOIN [010BDCOMUN].DBO.MAEART AS M 
