...
CONVERT(VARCHAR,REQ_FECHA_AUTORI,103)AS REQ_FECHA_AUTORI,
CASE REQ_ESTADO
WHEN '00'  THEN 'EMITIDO'
WHEN '01'  THEN 'ATENDIDO'
WHEN '03'  THEN 'REC-PARCIAL'
...
?>
<tr>
<td><a href="editar-rqm?numero=<?php echo $fila->REQ_NUMERO?>" target="_blank"><?php echo $fila->REQ_NUMERO; ?></a></td>
