...
having (ISNULL(STSKDIS,0)-SUM(ISNULL(CANT_PEND,0)))<0";
...
<td><a  href="../reportes/detalle/consulta-articulos?codigo=<?php echo utf8_encode($fila->ACODIGO)?>" target="_blank"><i class="glyphicon glyphicon-zoom-in"></i></a></td>
</tr>
