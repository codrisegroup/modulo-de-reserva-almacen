      ...
      <ul class="nav navbar-nav">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li class="divider"></li>
            <li><a href="/<?php echo PATH; ?>/pages/reservas-automaticas">Reservas Automaticas</a></li>
            <li class="divider"></li>
            <li><a href="/<?php echo PATH; ?>/pages/reservas-por-regularizacion">Reservas Regularizacion</a></li>
            <li class="divider"></li>
